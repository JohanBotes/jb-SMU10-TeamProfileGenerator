...
const employeeArray = [];/* w w   w   .d   e  m  o 2    s  .  c o m  */

promptEmployee = () => {

  console.log("\x1b[33m",`
 ___._*_*_____._*__._*_*_____._*_
`);
console.log("\x1b[36m",`_ Team Profile Generator 1.0.0 _`);
  console.log("\x1b[33m", ` 
 ___._*_*_____._*__._*_*_____._*_
  `);
...
.then(html => {
  console.log("\x1b[33m", `
 ___._*_*_____._*__._*_*_____._*__._*_*_____._*___
`);console.log("\x1b[32m", 
"_ HTML Page Generated! Check the ./dist folder! _");
  console.log("\x1b[33m", `
 ___._*_*_____._*__._*_*_____._*__._*_*_____._*___
`, "\x1b[00m")
